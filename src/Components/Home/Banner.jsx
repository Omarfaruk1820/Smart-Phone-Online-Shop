  ...
  const [offers] = useState([
    {
      ...
      image:
        "https://i.ibb.co/y3HPhxY/bobby-raj-sirimani-lkhz29-AXTTc-unsplash.jpg",
      discount: "40% OFF",
    ...
    },
    {
      ...
      highlight: "Hot Deal",
      image:
        "https://i.ibb.co/tT4DfkgZ/amanz-f-Yru5-LNy-Ji-M-unsplash.jpg",
      discount: "FREE GIFTS",
    ...
    },
    {
      ...
      image:
        "https://i.ibb.co/yFfdPf4L/marios-gkortsilas-v-yctr-Wm-RHo-unsplash.jpg",
      discount: "NEW",
  ...
  return (
    <div className="w-full">
      ...
      >
        {offers.map((item) => (
          <SwiperSlide key={item.id}>
            <div
              className="relative w-full h-[70vh] md:h-[80vh] flex items-center justify-center text-white"
              style={{
      ...
      <div className="bg-base-200 py-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 text-center gap-4 text-sm font-medium">
